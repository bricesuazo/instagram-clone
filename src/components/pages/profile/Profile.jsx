        ...
        <div className="profile">
            ...
            <div className="profileTopWrapper">
                <div className="profileTopUser">
                    <img src="https://yt3.ggpht.com/7WdX-cflWvM1AQeqQsib51WqrPi-QHl7970vrcWUe7h-_pZMXDqGnBvuaEBsINaLSnZYsLRKEA=s900-c-k-c0x00ffffff-no-rj" alt="" className="profileTopProfilePic" />
                ...
                <div className="profileTopInfoWrapper">
                    ...
                    <div className="profileTopInfoBioWrapper">
                        <span className="profileTopInfoBio">
                            Motion Designer | Video Editor | TV Broadcaster<br/>Computer Science Student<br/>-<br/>Master Editor & Cinematographer @gulamanentertainment
                        </span>
                    </div>
                    <Link to="https://bricesuazo.com" target="_blank" rel="noopener noreferrer" style={{textDecoration: 'none'}} className="profileTopWebsite">www.bricesuazo.com</Link>
                </div>
                <div className="profileTopInfoDataNumbersWrapper">
                    ...
                    <Link to="/:username/followers" style={style} className="profileTopInfoDataNumbersFollowersWrapper">
                        <span className="profileTopInfoDataNumbersNum">618</span>
                        <span className="profileTopInfoDataNumbersLabel">followers</span>
                    </Link>
                    <Link to="/:username/following" style={style} className="profileTopInfoDataNumbersFollowingWrapper">
                ...
                <div className="profileTopSectionBtnsWrapper">
                    <div className="profileTopSectionBtns">
                        <Link to="/:username" style={style} className="bx bx-grid profileTopSectionBtn" ></Link>
                        <Link to="/channel" style={style} className="bx bx-play-circle profileTopSectionBtn" ></Link>
                        <Link to="/tagged" style={style} className="bx bx-tag-alt bx-rotate-270 profileTopSectionBtn" ></Link>
                        <Link to="/saved" style={style} className="bx bx-clipboard profileTopSectionBtn" ></Link>
                    </div>
                </div>
            </div>
            ...
            <div className="profileUploadedContainer">
                {profilePost.map(item => (
                    <UploadedContainer img={item.img} type={item.type} like={item.like} comment={item.comment}/>
                ))}
            </div>
        </div>
    )
