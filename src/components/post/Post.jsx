            ...
            <div className="postWrapper">
                <div className="postHeader">
                    <div className="postUser">
                        <img src={post.profilePicture} alt="" className="postUserProfilePic" />
                ...
                <div className="postMediaWrapper">
                    <div className={post.type !== 'multiple' ? "postMediaMultipleBtns" : "postMediaMultipleBtns multiple"}>
                ...
                <div className="postInfoWrapper">
                    ...
                    <div className="postInfoCaptionWrapper">
                        <span className="postInfoCaption"><span className="postInfoCaptionUsername">{post.username}</span>&nbsp;&nbsp;{post.desc}</span>
                    </div>
                    <div className="postInfoCommentWrapper">
                        <span className="postInfoComment">View all {post.comments.length} comments</span>
                    </div>
                    <div className="postInfoDateWrapper">
                        <span className="postInfoDate">{timeAgo.format(post.dateUploaded - 60 * 1000)}</span>
                    </div>
                </div>
            </div>
        </div>
